...
void autonomous(void) {
  ...
  //ReversePID(4, 0.9, 0.000, 0.8, true);
  wait(0.2, seconds);
  resetMotorValues();
 ...
 // wait(0.1, sec);
  ...
  leftRotatingPID(24, 0.6, 0.0, 0.5); 
  resetMotorValues();
  //LeftDriveSmart.resetPosition();
  //RightDriveSmart.resetPosition();
  
 /*
 ReversePID(1.5, 0.6, 0, 0.2, true);
  LeftDriveSmart.resetPosition();
  RightDriveSmart.resetPosition();
  resetMotorValues();
*/
  ForwardPID(25, 5, 0.1, 5, true);
  LeftDriveSmart.resetPosition();
  RightDriveSmart.resetPosition();
 ...
 //pneuCylinRight.set(true);
  ...
  ReversePID(6, 0.8, 0, 0.1, true);
  LeftDriveSmart.resetPosition();
  RightDriveSmart.resetPosition();

  
  leftRotatingPID(3, 0.8, 0.0, 0.0);
  resetMotorValues();


  leftRotatingPID(85, 0.25, 0.0, 0.85);
  resetMotorValues(); 
 ...
 leftRotatingPID(25, 0.7, 0.0, 0.3);
  resetMotorValues();
  intake.spin(forward);
  wait(0.3, seconds);
  //intake.stop();
  ...
  intake.spin(reverse);
  ReversePID(10, 0.6, 0.0, 0.6, true);      
  resetMotorValues();
  ...
  leftRotatingPID(25, 0.3, 0, 0.3);
  intake.spin(reverse);
  resetMotorValues();
  ReversePID(15, 0.7, 0.0, 0.8, true);
  resetMotorValues();

  // turn such that intake faces goal, outtake triball
  RotatingPID(45, 0.5, 0, 0.8);
  intake.spin(forward);
  wait(0.3, seconds);
  intake.stop();
